    ...
    <Container fluid className="team-comp">
      <Container className="team-comp-container">
        ...
        <Row className="team-comp-content d-flex justify-content-center align-items-center">
          {
            teamData.map((val, index) => (
              <Col data-aos={(index % 2 === 0 ? "fade-up" : "fade-down")} lg={3} md={4} sm={12} key={index}
                ...
                <div className="member-title d-flex flex-column justify-content-center align-items-center">
        ...
        <Row data-aos="fade-down"
             className="team-comp-scroll d-flex flex-column justify-content-center align-items-center">
